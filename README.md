...
SharpApi is the direct evolution of SharpHelpers. An improved and more structured project to make developer's life easier.

Get SharpApi:

	git clone git://github.com/sharpcodingIT/SharpCodingApi/
...
### License
 ...
 The SharpApi are released under the [The MIT License (MIT)](LICENSE).
 SharpApi Library source and binaries are **completely free for commercial and non commercial use**.
--------------------------------------
### Sponsors
